...
class BaseController(Generic[ModelType, SchemaType]):
    ...
    def _add_routes(self):
        ...
        async def create_item(item_in: dict = Body(...), db: AsyncSession = Depends(get_session)):
        ...
        async def update_item(item_id: int, item_in: dict = Body(...), db: AsyncSession = Depends(get_session)):
